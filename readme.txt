...
2. Configuration form -> statistics to show and user selection
3. Configuration form -> searching for an Instagram user
4. Configuration form -> specifying the widget colour scheme
5. Configuration form -> more advanced settings
